...
threads_option = click.option('--threads', required=True, type=int, help='Number of threads', default=psutil.cpu_count())
...
def cgc_substrate_base_options(func):
    """base opiton"""
    func = click.option('-i', '--input_folder', required=True, help="input folder for the cgc substrate")(func)
