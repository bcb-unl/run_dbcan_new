...
class Test_dbCAN:
    ...
    def test_run_dbCAN_database(args):
        args = type('', (), {})()
    ...
    def test_easy_substrate_prok_fna(args):
        args = type('', (), {})()
        ...
        args.methods = ['diamond', 'hmm', 'dbCANsub']
        ...
        assert os.path.exists(os.path.join(args.output, 'uniInput.faa'))
        assert os.path.exists(os.path.join(args.output, 'overview.tsv'))
        assert os.path.exists(os.path.join(args.output, 'cgc_standard_out.tsv'))
        assert os.path.exists(os.path.join(args.output, 'substrate.out'))
        assert os.path.exists(os.path.join(args.output, 'synteny_pdf'))

    def test_easy_substrate_prok_faa(args):
        args = type('', (), {})()
    ...
    def test_easy_substrate_meta_fna(args):
        args = type('', (), {})()
        args.input_raw_data = os.path.join(DATA_ROOT, 'EscheriaColiK12MG1655.fna')
        args.mode = 'meta'
        args.input_format = "NCBI"
    ...
    def test_easy_substrate_NCBI_euk_faa(args):
        args = type('', (), {})()
    ...
    def test_easy_substrate_JGI_euk(args):
